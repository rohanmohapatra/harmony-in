...
const useStyles = makeStyles(theme => ({
  ...
  quote: {
    ...
    alignItems: 'center',
    backgroundImage: 'url(/images/login/seller.svg)',
...
const SellerSignIn = props => {
  ...
  const handleSellerSignIn = event => {
    ...
    .then(function(response){
      ...
      setTimeout(function() { history.push("/seller/dashboard"); }, 4000);
          ...
          <div className={classes.content}>
            ...
            <div className={classes.contentBody}>
              ...
              >
                ...
                />
                <Button
                  className={classes.SellerSignInButton}
                  color="primary"
